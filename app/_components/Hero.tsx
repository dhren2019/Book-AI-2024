...
import Head from 'next/head'; // Añadir esta línea para importar Head
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Create personalized AI-generated stories for children that ignite imagination and passion for reading. Discover fun, easy, and magical storytelling for your kids today!" />
      </Head>
